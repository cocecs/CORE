                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div class="flex flex-wrap gap-3">
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" class="peer sr-only" name="professional_level" value="entrylevel"/>
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" class="peer sr-only" name="professional_level" value="junior"/>
                                    <div class="w-60 max-w-xl rounded-md bg-white p-5 text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                                    <div class="flex flex-col gap-1">
                                        <div class="flex items-center justify-between">
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" class="peer sr-only" name="professional_level" value="mid-level" />
                                    <div class="w-60 max-w-xl rounded-md bg-white p-5 text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                                    <div class="flex flex-col gap-1">
                                        <div class="flex items-center justify-between">
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" class="peer sr-only" name="professional_level" value="senior"/>
                                    <div class="w-60 max-w-xl rounded-md bg-white p-5 text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                                    <div class="flex flex-col gap-1">
                                        <div class="flex items-center justify-between">
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" class="peer sr-only" name="professional_level" value="manegerial" />
                                    <div class="w-60 max-w-xl rounded-md bg-white p-5 text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                                    <div class="flex flex-col gap-1">
                                        <div class="flex items-center justify-between">
