...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-semibold text-gray-700">What shift you prefered?</h2>
    </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div class="flex flex-wrap gap-3">
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" class="peer sr-only" name="job_shift" value="1"/>
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" class="peer sr-only" name="job_shift" value="2"/>
                                    <div class="w-60 max-w-xl rounded-md bg-white p-5 text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                                    <div class="flex flex-col gap-1">
                                        <div class="flex items-center justify-between">
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" class="peer sr-only" name="job_shift" value="3" />
                                    <div class="w-60 max-w-xl rounded-md bg-white p-5 text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-sky-600 peer-checked:ring-blue-400 peer-checked:ring-offset-2">
                                    <div class="flex flex-col gap-1">
                                        <div class="flex items-center justify-between">
