...
<div class="max-w-4xl mx-auto my-8 p-6 bg-slate-50 text-slate-800 antialiased font-sans space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-3">
                    @if($userDetails->barangay || $userDetails->town || $userDetails->province)
                        <div class="flex items-start gap-3 text-sm text-slate-600">
                            ...
                            <div>
                                ...
                                <p class="font-medium text-slate-700 mt-0.5">
                                    {{ implode(', ', array_filter([$userDetails->barangay, $userDetails->town, $userDetails->province])) }}
                                </p>
                            </div>
                        </div>
                    @endif
